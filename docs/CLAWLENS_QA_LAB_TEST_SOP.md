...
- [QA Lab 本地验证实测](research/RESEARCH_OPENCLAW_QA_LAB_LOCAL_ENABLEMENT_FINDINGS_2026-04-13.md)
- [SOP 改进分析](research/ANALYSIS_CLAWLENS_QA_LAB_SOP_IMPROVEMENTS_2026-04-13.md)
- [插件开发工作流](CLAWLENS_PLUGIN_DEV_WORKFLOW.md)

## 历史版本

- 过程版本（草案）：[IMPLEMENTATION_CLAWLENS_QA_LAB_TEST_SOP_DRAFT_2026-04-13.md](plans/IMPLEMENTATION_CLAWLENS_QA_LAB_TEST_SOP_DRAFT_2026-04-13.md)
