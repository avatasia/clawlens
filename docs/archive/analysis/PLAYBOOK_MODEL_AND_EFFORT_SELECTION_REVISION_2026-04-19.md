---
status: merged
superseded_by: docs/PLAYBOOK_MODEL_AND_EFFORT_SELECTION.md
created: 2026-04-19
updated: 2026-04-19
---

# Model and Effort Selection Playbook Revision

> [!IMPORTANT]
> Archived revision draft for [docs/PLAYBOOK_MODEL_AND_EFFORT_SELECTION.md](../../PLAYBOOK_MODEL_AND_EFFORT_SELECTION.md).
>
> 本稿吸收外部 review 的 tightening comments，并已于 2026-04-19 合并回顶层主文档。

> [!NOTE]
> Review record: see [REVIEW_ROUND_MODEL_AND_EFFORT_SELECTION_2026-04-19.md](../reviews/REVIEW_ROUND_MODEL_AND_EFFORT_SELECTION_2026-04-19.md).
...
- [PLAYBOOK_MODEL_AND_EFFORT_SELECTION.md](../../PLAYBOOK_MODEL_AND_EFFORT_SELECTION.md) — 当前顶层主文档
